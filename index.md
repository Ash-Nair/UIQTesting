...
You can use the [editor on GitHub](https://github.com/Ash-Nair/UIQTesting/edit/master/index.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/Ash-Nair/UIQTesting/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
        ...
        <script type="text/javascript">
          (function(){
            ...
            useriq.identify(user_id, {
              ...
              account_name: 'Ashwin Test GH',
              user_email: 'ashwin.nair+tu@useriq.com',
              signup_date: '2017-11-28',
            })
            useriq.startTracker()
